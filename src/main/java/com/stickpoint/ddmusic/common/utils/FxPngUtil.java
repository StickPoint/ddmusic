...
public class FxPngUtil extends Object {
     ...
     * @see Image
     */
    public FxPngUtil(Image image, boolean encodeAlpha) {
     ...
     * @see Image
     */
    public FxPngUtil(Image image, boolean encodeAlpha, int whichFilter, int compLevel) {
        this.image = image;
    ...
    public static void main(String[] args) {
        try {
            Image myImage = new Image(Objects.requireNonNull(FxPngUtil.class.getResource("/img/123.jpg")).openStream());
            FxPngUtil util = new FxPngUtil(myImage,true);
            File file = new File("Sinsy-Image-" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("uuuuMMdd-HHmmss")) + ".png");
            FileOutputStream fos = new FileOutputStream(file);
            fos.write(util.pngEncode());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
